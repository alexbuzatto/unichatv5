...
import AgentSidebarSettings from './components/AgentSidebarSettings.vue';
  ...
  methods: {
    async initializeAccount() {
      try {
        ...
        this.agentSidebarConfig = agent_sidebar_config || {
          main_sidebar: {},
          right_sidebar: {},
        };
        this.brandingConfig = branding_config || {
          logo_main: '',
          logo_dark: '',
          logo_light: '',
          favicon: '',
    ...
    async updateAccount() {
      ...
      try {
        await this.$store.dispatch('accounts/update', {
          ...
          agent_sidebar_config: this.agentSidebarConfig,
          branding_config: this.brandingConfig,
        });
...
<template>
  <div class="flex flex-col max-w-2xl mx-auto w-full">
    ...
    <AgentSidebarSettings v-model="agentSidebarConfig" />
    <BrandingSettings v-model="brandingConfig" />
