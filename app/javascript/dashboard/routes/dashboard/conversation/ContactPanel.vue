...
<template>
  <div class="w-full">
    ...
    />
    <ContactInfo
      v-if="isSidebarItemVisible('contact_info', 'right_sidebar')"
      :contact="contact"
        ...
        <template #item="{ element }">
          <div
            v-if="
              ...
              isSidebarItemVisible('conversation_actions', 'right_sidebar')
            "
          ...
          <div
            v-else-if="
              ...
              isSidebarItemVisible('conversation_participants', 'right_sidebar')
            "
            class="conversation--actions"
          >
            <AccordionItem
          ...
          <div
            v-else-if="
              ...
              isSidebarItemVisible('conversation_info', 'right_sidebar')
            "
          >
            <AccordionItem
          ...
          <div
            v-else-if="
              ...
              isSidebarItemVisible('contact_attributes', 'right_sidebar')
            "
          >
            <AccordionItem
          ...
          <div
            v-else-if="
              ...
              isSidebarItemVisible('previous_conversation', 'right_sidebar')
            "
          >
            <AccordionItem
              v-if="contact.id"
          ...
          <woot-feature-toggle
            v-else-if="
              element.name === 'macros' &&
              isSidebarItemVisible('macros', 'right_sidebar')
            "
            feature-key="macros"
          >
            <AccordionItem
          ...
          <div
            v-else-if="
              ...
              isSidebarItemVisible('contact_notes', 'right_sidebar')
            "
          >
            <AccordionItem
