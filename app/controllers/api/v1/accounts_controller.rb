class Api::V1::AccountsController < Api::BaseController
  ...
  def settings_params
    ...
    permitted[:agent_sidebar_config] = params[:agent_sidebar_config].permit! if params[:agent_sidebar_config].present?
    permitted[:branding_config] = params[:branding_config].permit! if params[:branding_config].present?
    permitted
  end
