...
class Account < ApplicationRecord
    ...
    'properties':
      {
        ...
        'branding_config': {
          'type': %w[object null],
          'properties': {
            'logo_main': { 'type': %w[string null] },
            'logo_dark': { 'type': %w[string null] },
            'logo_light': { 'type': %w[string null] },
            'favicon': { 'type': %w[string null] },
            'logo_email': { 'type': %w[string null] },
            'logo_super_admin': { 'type': %w[string null] }
          },
          'additionalProperties': false
        },
  ...
  store_accessor :settings, :captain_models, :captain_features, :agent_sidebar_config, :branding_config
