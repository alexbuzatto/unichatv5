...
const tailwindConfig = {
  ...
  content: [
    ...
    './app/javascript/v3/**/*.{vue,js,jsx}',
    './app/javascript/dashboard/**/*.{vue,js,jsx}',
    './app/javascript/portal/**/*.{vue,js,jsx}',
    './app/javascript/shared/**/*.{vue,js,jsx}',
    './app/javascript/survey/**/*.{vue,js,jsx}',
    './app/javascript/dashboard/components-next/**/*.{vue,js,jsx}',
    './app/javascript/dashboard/helper/**/*.{js,jsx}',
    './app/javascript/dashboard/composables/**/*.{js,jsx}',
    './app/javascript/dashboard/components-next/**/*.{js,jsx}',
    './app/javascript/dashboard/routes/dashboard/**/**/*.{js,jsx}',
    './app/views/**/*.html.erb',
  ],
  theme: {
    extend: {
      fontFamily: {
        sans: ['Outfit', ...defaultSansFonts],
        outfit: ['Outfit', ...defaultSansFonts],
      },
      typography: {
        bubble: {
          css: {
